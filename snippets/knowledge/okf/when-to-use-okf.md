...
Use the Open Knowledge Format (OKF) when documenting a knowledge base: durable context, curated
insight, and metadata about data, systems, or processes -> reach for OKF.
...
- Building a collection that should be self-describing, portable, and version-controlled.
