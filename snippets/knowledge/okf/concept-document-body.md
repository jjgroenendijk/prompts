...
do not. Put the footnote reference marker immediately after the sentence it attributes, with no
space before it, and put the matching footnote definition on its own line after the paragraph,
carrying the source title as its text.
