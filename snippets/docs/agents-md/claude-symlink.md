...
Each directory with an `AGENTS.md` MUST also hold a `CLAUDE.md` symlink to it. Run `ln -s
AGENTS.md CLAUDE.md`. Both agents and Claude Code then read one file. Commit the link, never a
copy.
